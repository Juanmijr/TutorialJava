package capítulo4.ejercicioExtra02_La_Oca.version03;
...
public class Principal {
	 ...
	 */
	private static void inicializaTablero (Casilla tablero[]) {
		...
		tablero[9] = new Casilla(10, "Rat�n");
		...
		tablero[24] = new Casilla(25, "Le�n");
		...
		tablero[28] = new Casilla(29, "Delf�n");
		tablero[29] = new Casilla(30, "Drag�n");
		...
		tablero[41] = new Casilla(42, "Laberinto", null, 0, "Te has perdido, vuelves a 30");
	 ...
	 */
	private static  void imprimeTablero (Casilla tablero[]) {
		for (int i = 0; i < tablero.length; i++) {
			System.out.println(tablero[i].getOrden() + " - " +
					tablero[i].getNombre());
		}
	}
